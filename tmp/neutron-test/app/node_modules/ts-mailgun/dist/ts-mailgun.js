...
var NodeMailgun = /** @class */ (function () {
     ...
     */
    NodeMailgun.prototype.send = function (to, subject, body, templateVars, sendOptions) {
        var _this = this;
        ...
        return new Promise(function (accept, reject) {
            ...
            if (!body || (sendOptions === null || sendOptions === void 0 ? void 0 : sendOptions.template)) {
                delete message.html;
            }
            // Send email
     ...
     * @param sendOptions Object Additional message options to send
     */
    NodeMailgun.prototype.sendFromTemplate = function (to, template, templateVars, sendOptions) {
        if (templateVars === void 0) { templateVars = {}; }
        if (sendOptions === void 0) { sendOptions = {}; }
        var subject, body;
