...
const TotalRevenueCard = ({ dailyStats, weeklyStats, isLoading }) => {
    const isDeltaPositive = useMemo(() => {
        ...
        if (!weeklyStats)
            return false;
        return (weeklyStats[0].totalRevenue - ((_a = weeklyStats[1]) === null || _a === void 0 ? void 0 : _a.totalRevenue)) > 0;
    }, [weeklyStats]);
    const deltaPercentage = useMemo(() => {
        var _a, _b, _c, _d;
        if (!weeklyStats || weeklyStats.length < 2 || isLoading)
            return;
        if (((_a = weeklyStats[1]) === null || _a === void 0 ? void 0 : _a.totalRevenue) === 0 || ((_b = weeklyStats[0]) === null || _b === void 0 ? void 0 : _b.totalRevenue) === 0)
            return 0;
        weeklyStats.sort((a, b) => b.id - a.id);
        const percentage = ((weeklyStats[0].totalRevenue - ((_c = weeklyStats[1]) === null || _c === void 0 ? void 0 : _c.totalRevenue)) / ((_d = weeklyStats[1]) === null || _d === void 0 ? void 0 : _d.totalRevenue)) * 100;
    ...
    return (<div className='rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark'>
      ...
      <div className='mt-4 flex items-end justify-between'>
        <div>
          <h4 className='text-title-md font-bold text-black dark:text-white'>${dailyStats === null || dailyStats === void 0 ? void 0 : dailyStats.totalRevenue}</h4>
